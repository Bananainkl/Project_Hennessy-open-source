...
- The full player hides the standard toolbar through `NSWindow` while preserving native close, minimize, and zoom controls at their main-window coordinates; it must not replace or reposition the traffic-light controls with hand-drawn buttons.
